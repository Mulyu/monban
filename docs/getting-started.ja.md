...
- パス構造: [path.md](path.ja.md)
- ファイル内容: [content.md](content.ja.md)
- ドキュメント: [doc.md](doc.ja.md)
- GitHub: [github.md](github.ja.md)
- Git メタデータ: [git.md](git.ja.md)
...
- 組織共通のルールを再利用するなら [extends.md](extends.ja.md)
- monban の設計思想は [concepts.md](concepts.ja.md)
